...
└──────────────`, m)
  } else conn.reply(m.chat, `❎ Извини, тебе не хватает *XP* чтобы купить Алмазы💎\n\n Вы можете получить *XP* используя команды из *меню бота и экономика*`, m)
}
handler.help = ['Купить', 'КупитьВсе']
handler.tags = ['econ']
handler.command = ['купить', 'купитьвсе'] 
